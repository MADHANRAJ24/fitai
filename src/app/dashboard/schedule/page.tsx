...
import { Calendar, Clock, RotateCcw, Check, Sparkles, Dumbbell, Zap, CheckCircle2 } from "lucide-react"
    ...
    const generate = () => {
        ...
        setTimeout(() => {
            ...
            setGeneratedSchedule([
                { day: "Mon", type: "Upper Body Strength", duration: preferences.duration, icon: Dumbbell },
                { day: "Wed", type: "HIIT Cardio", duration: preferences.duration, icon: Zap },
                { day: "Fri", type: "Lower Body Power", duration: preferences.duration, icon: Dumbbell },
                { day: "Sun", type: "Active Recovery (Yoga)", duration: "30 min", icon: Sparkles },
            ])
            setStep(4)
        }, 3000)
    }
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                                {["30 min", "45 min", "60 min"].map(d => (
                                                    <motion.button
                                                        ...
                                                        className={`p-6 rounded-2xl border text-center transition-all ${preferences.duration === d
                                                            ? "bg-primary text-primary-foreground border-primary shadow-[0_0_15px_rgba(16,185,129,0.4)]"
                                                            : "bg-white/5 hover:bg-white/10 text-muted-foreground border-white/10"
                                                            }`}
                                                    >
                                ...
                                {step === 4 && (
                                    ...
                                    >
                                        {generatedSchedule?.map((s: any, i: number) => (
                                            ...
                                            >
                                                <div className="h-12 w-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary font-bold border border-primary/20 group-hover:scale-110 transition-transform">
